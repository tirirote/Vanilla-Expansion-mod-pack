...
playsound minecraft:item.trident.hit player @a ~ ~ ~ 1 1

# 1. PIEDRA / MINERALES (#minecraft:mineable/pickaxe)
execute if block ~ ~ ~ #minecraft:mineable/pickaxe run playsound minecraft:block.stone.break player @a ~ ~ ~ 0.8 1.2
...
execute if block ~ ~ ~ #minecraft:mineable/axe run playsound minecraft:block.wood.break player @a ~ ~ ~ 0.8 1.2
...
execute if block ~ ~ ~ #minecraft:mineable/shovel run playsound minecraft:block.grass.break player @a ~ ~ ~ 0.8 1.2
...
execute if block ~ ~ ~ #minecraft:mineable/hoe run playsound minecraft:block.grass.break player @a ~ ~ ~ 0.5 1.5
...
execute unless block ~ ~ ~ #minecraft:mineable/pickaxe unless block ~ ~ ~ #minecraft:mineable/axe unless block ~ ~ ~ #minecraft:mineable/shovel unless block ~ ~ ~ #minecraft:mineable/hoe run playsound minecraft:block.anvil.hit player @a ~ ~ ~ 0.5 1.5
