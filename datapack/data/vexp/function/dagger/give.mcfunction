...
execute if entity @s[tag=vexp.wood] run data modify storage vexp:main params merge value {damage: 1,item_id:"wooden_sword", name:"Daga de Madera", model:"vexp:wooden_dagger", dmg:2.0, spd:2.0}
