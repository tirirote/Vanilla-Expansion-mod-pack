...
execute as @e[type=item_display,tag=vexp.custom_mob_display,distance=..64] if entity @s[tag=vexp.custom_mob_spin_rotation] if score @s vexp.id = @s vexp.id run function vexp:custom_mobs/display/spin_rotation with entity @s data.vexp.mob_display
