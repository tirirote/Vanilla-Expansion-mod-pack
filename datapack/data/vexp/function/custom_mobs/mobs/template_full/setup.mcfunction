...
data modify entity @s data set value {vexp:{mob:{type:"template", custom_name:"Template", is_hostile:0, scale:1.0f, hp:10, speed:0.0, damage:0, special_damage:0, range:0.0, special_range:0.0, cooldown:0, special_cooldown:0, special_chance:0, can_pickup_item:0, can_eat_item:0, favorite_items:"#custom_item_tag", item_pos_x:0.0f, item_pos_y:0.0f, item_pos_z:0.0f,item_rx:0.0f}}}
