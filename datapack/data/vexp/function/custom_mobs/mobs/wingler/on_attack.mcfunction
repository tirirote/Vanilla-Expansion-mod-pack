...
# @s is the custom mob
execute positioned ^ ^0.5 ^1 if block ^ ^ ^ #replaceable run tp @s ^ ^ ^ ~ ~12
execute positioned ^ ^0.5 ^2 if block ^ ^ ^ #replaceable run tp @s ^ ^ ^ ~ ~12
execute positioned ^ ^0.5 ^3 if block ^ ^ ^ #replaceable run tp @s ^ ^ ^ ~ ~12
