...
data modify entity @s data set value {vexp:{mob:{type:"wingler", custom_name:"Grajo", is_hostile:1, can_hunt:1, hunt_targets:"pig", scale:1.35f, hp:15, speed:0.3, damage:6, special_damage:6, range:1.5, special_range:5.0, cooldown:32, special_cooldown:128, special_chance:30, can_pickup_item:1, can_eat_item:0, favorite_items:"#vexp:wingler_favorite_items", item_pos_x:0.0f, item_pos_y:-0.45f, item_pos_z:0.65f,item_rx:-0.303f}}}
...
# Summon custom Model
function vexp:custom_mobs/custom_item_display_macro {item:"minecraft:stone", model:"wingler_overlay", x:0f, y:-0.1f, z:0.1f, rx:-0.303f, ry:0.0f, rz:0.0f, scale:1.4f, spin_rotation:0}
