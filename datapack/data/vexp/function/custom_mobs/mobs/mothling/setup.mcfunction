#Custom mob data
data modify entity @s data set value {vexp:{mob:{type:"mothling",custom_name:"Ashling", hp:20, speed:0.4, damage:6, special_damage:4, range:1.25, special_range:2.5, cooldown:16, special_cooldown:96, special_chance:30}}}
...
# Summon custom Model
function vexp:custom_mobs/custom_item_display_macro {model:"mothling_overlay", x:0f, y:0.1f, z:0.25f, rx:0.101f, ry:0.0f, rz:0.0f, scale:1.35f, spin_rotation:0}
