...
data modify entity @s data set value {vexp:{mob:{type:"ashling",custom_name:"Ashling", is_hostile:1, can_hunt:1, hunt_targets:"#vexp:ashling_favorite_mobs", scale:1.125f, hp:20, speed:0.3, damage:8, special_damage:6, range:1.5, special_range:2.5, cooldown:32, special_cooldown:128, special_chance:30, can_pickup_item:1, can_eat_item:1, favorite_items:"#vexp:ashling_favorite_items", item_pos_x:0.0f, item_pos_y:-0.35f, item_pos_z:0.85f,item_rx:-0.707f}}}
...
# Summon custom Model
function vexp:custom_mobs/custom_item_display_macro {item:"minecraft:stone", model:"ashling_overlay", x:0f, y:-0.05f, z:0.15f, rx:-0.101f, ry:0.0f, rz:0.0f, scale:1.5f, spin_rotation:0}
