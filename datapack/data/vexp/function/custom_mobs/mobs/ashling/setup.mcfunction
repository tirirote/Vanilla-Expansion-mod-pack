...
data modify entity @s data set value {vexp:{mob:{type:"ashling",custom_name:"Ashling", is_hostile:1, scale:1.125f, hp:20, speed:0.4, damage:6, special_damage:4, range:2.0, special_range:2.5, cooldown:16, special_cooldown:96, special_chance:30, can_pickup_item:1, can_eat_item:1, favorite_items:"#vexp:mothling_favorite_items", item_pos_x:0.0f, item_pos_y:-0.35f, item_pos_z:0.85f,item_rx:-0.707f}}}
