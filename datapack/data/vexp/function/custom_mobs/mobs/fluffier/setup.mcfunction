...
data modify entity @s data set value {vexp:{mob:{type:"fluffier", custom_name:"Fluffier", is_hostile:0, can_hunt:0, hunt_targets:"#vexp:targets", scale:1.0f, hp:10, speed:0.0, damage:0, special_damage:0, range:0.0, special_range:16.5, cooldown:0, special_cooldown:48, special_chance:50, can_pickup_item:1, can_eat_item:1, favorite_items:"#vexp:fluffier_favorite_items", item_pos_x:0.0f, item_pos_y:-0.6f, item_pos_z:0.45f,item_rx:0.303f}}}
