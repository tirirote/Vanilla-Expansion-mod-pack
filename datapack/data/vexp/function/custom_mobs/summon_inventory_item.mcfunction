...
execute as @e[type=item_display,tag=vexp.temp_custom_mob_inventory,sort=nearest,distance=..3.5] run scoreboard players operation @s vexp.id = #cm_host_id vexp.math

execute as @e[type=item_display,tag=vexp.temp_custom_mob_inventory,sort=nearest,distance=..3.5] run ride @s mount @e[tag=vexp.custom_mob,sort=nearest,limit=1,distance=..1]
tag @e[type=item_display,tag=vexp.temp_custom_mob_inventory,sort=nearest,distance=..3.5] remove vexp.temp_custom_mob_inventory
