...
$summon item_display ~ ~1 ~ {Tags:["vexp.custom_mob_display","vexp.custom_mob_inventory"],item:$(item),billboard:"fixed",transformation:{left_rotation:[$(rx),$(ry),$(rz),1f],right_rotation:[0f,0f,0f,1f],translation:[$(x),$(y),$(z)],scale:[$(scale),$(scale),$(scale)]},teleport_duration:1,interpolation_duration:1,view_range:1.0f}
