...
#Ranged
execute if entity @s if predicate vexp:enemy_holding_bow positioned ~ ~1.5 ~ if block ^ ^ ^0.2 #air if entity @p[distance=..16] run function vexp:feedback/family/ranged_bow
execute if entity @s if predicate vexp:enemy_holding_bow positioned ~ ~1.5 ~ unless block ^ ^ ^0.2 #air unless entity @p[distance=..16] run scoreboard players set @s vexp.enemy_atk_time 0
...
execute if entity @s if predicate vexp:enemy_holding_extended_reach if entity @p[gamemode=!spectator,distance=..4.5] positioned ^ ^ ^2 run function vexp:feedback/family/melee_20
execute if entity @s if predicate vexp:enemy_holding_extended_reach if entity @p[gamemode=!spectator,distance=..4.5] positioned ^ ^ ^2 run function vexp:feedback/family/melee_30
