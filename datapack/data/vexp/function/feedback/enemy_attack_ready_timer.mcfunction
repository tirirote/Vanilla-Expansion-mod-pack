...
execute if entity @s[type=#vexp:feedback_melee_20] unless predicate vexp:enemy_holding_extended_reach if entity @p[gamemode=!spectator,distance=..2.5] run function vexp:feedback/family/melee_20
execute if entity @s[type=#vexp:feedback_melee_30] unless predicate vexp:enemy_holding_extended_reach if entity @p[gamemode=!spectator,distance=..2.5] run function vexp:feedback/family/melee_30

#Meelee - extended reach (trident ~4.5, scythe ~5.5)
execute if entity @s[type=#vexp:feedback_melee_20] if predicate vexp:enemy_holding_extended_reach if entity @p[gamemode=!spectator,distance=..4.5] run function vexp:feedback/family/melee_20
execute if entity @s[type=#vexp:feedback_melee_30] if predicate vexp:enemy_holding_extended_reach if entity @p[gamemode=!spectator,distance=..4.5] run function vexp:feedback/family/melee_30
