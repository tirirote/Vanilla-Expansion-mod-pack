...
execute if data entity @s data.vexp.pan_item at @s run summon item_display ~ ~ ~ {Tags:["vexp.frying_pan.item","vexp.frying_pan.new","vexp.inventory_visual"],item:{id:"minecraft:stone",count:1},transformation:{translation:[0f,0.125f,0f],scale:[0.75f,0.75f,0.75f],left_rotation:[1f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},teleport_duration:1,interpolation_duration:2}
