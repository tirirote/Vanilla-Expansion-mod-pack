...
#Left
execute as @e[type=item_display,tag=vexp.custom_block.display,tag=!vexp.neighbour.right] if score @s vexp.id = #temp vexp.id run data merge entity @s {start_interpolation:0,interpolation_duration:2,transformation:{left_rotation:[0f,1f,0f,0f],right_rotation:[0f,0f,0f,1f],translation:[-0.44f,0.475f,0.375f],scale:[1.005f,1.001f,1.001f]}}

#Right
execute as @e[type=item_display,tag=vexp.custom_block.display,tag=!vexp.neighbour.left] if score @s vexp.id = #temp vexp.id run data merge entity @s {start_interpolation:0,interpolation_duration:2,transformation:{left_rotation:[0f,1f,0f,0f],right_rotation:[0f,0f,0f,1f],translation:[0.44f,0.475f,0.44f],scale:[-1.005f,1.001f,-1.001f]}}
