...
$summon item_display ~ ~ ~ {Tags:["vexp.crate.inventory","vexp.crate.new"],item:$(item),transformation:{translation:[$(x),$(y),$(z)],scale:[0.75f,0.75f,0.75f],left_rotation:[1f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
