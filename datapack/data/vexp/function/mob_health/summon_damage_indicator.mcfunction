...
$execute anchored eyes run summon text_display ~ ~1 ~ {Tags:["vexp.damage_indicator","vexp.new_damage_indicator"],text:{"text":"-$(val)","color":"$(color)","bold":$(bold)},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},billboard:"center",teleport_duration:2,interpolation_duration:2}
