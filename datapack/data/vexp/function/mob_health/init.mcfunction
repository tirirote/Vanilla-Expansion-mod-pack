...
summon text_display ~ ~ ~ {Tags:["vexp.health_bar","vexp.new_bar"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[1f,1f,1f]},billboard:"center",alignment:"center",shadow:true,default_background:true}
