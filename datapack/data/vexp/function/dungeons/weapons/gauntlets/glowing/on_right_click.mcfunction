...
# Mark mob
execute positioned ^ ^ ^2.5 as @e[predicate=vexp:is_target,distance=..3.5,limit=1,sort=nearest,tag=vexp.state.catched] unless score @s vexp.id = #combo_owner_id vexp.id run function vexp:dungeons/states/glow_marked
