...
execute as @e[type=minecraft:item_display,tag=vexp.temp_projectile,tag=vexp.scythe_projectile,sort=nearest,limit=1,distance=..3] at @s run function vexp:projectile/spawn
