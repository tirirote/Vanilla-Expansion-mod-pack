...
data modify storage vexp:temp projectile_spawn set value {projectile_tag:"vexp.spellbook_projectile",proj_type:"nether_spellbook",proj_data:{}}
...
tag @s add vexp.projectile_owner
data modify storage vexp:temp projectile_spawn set value {projectile_tag:"vexp.spellbook_projectile1",proj_type:"nether_spellbook",proj_data:{}}
...
tag @s add vexp.projectile_owner
data modify storage vexp:temp projectile_spawn set value {projectile_tag:"vexp.spellbook_projectile2",proj_type:"nether_spellbook",proj_data:{}}
execute rotated as @s positioned ^0.8 ^ ^0.8 run function vexp:projectile/utils/create_armor_stand with storage vexp:temp projectile_spawn
