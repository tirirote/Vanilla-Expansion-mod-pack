...
execute as @e[predicate=vexp:is_target,distance=..2.5] at @s run function vexp:dungeons/weapons/sword/common_wave
...
# Feedback
execute positioned ~ ~1 ~ run function vexp:utils/feedback/dust_particle {initialColor: [0.8,0.8,0.8], finalColor: [0.9, 1.0, 1.0], scale: 1.7, dX: 0.2, dY: 0.0, dZ: 0.2, speed: 0.05, count: 3}
particle flash{color:-9145228} ~ ~1 ~ 0.0 0.0 0.0 0 0
