# dungeons/axe/glowing/on_right_click.mcfunction
# @s is the player
...
data modify storage vexp:temp projectile_spawn set value {projectile_tag:"vexp.axe_projectile",proj_type:"glowing_axe",proj_data:{}}
