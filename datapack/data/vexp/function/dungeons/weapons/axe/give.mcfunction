...
execute if entity @s[tag=vexp.wood] run data modify storage vexp:dungeons.weapon params merge value {item_id:"wooden_axe", name:"Hacha de Madera", model:"vexp:none", quality:"normal", dmg:7.0, spd:-2.2, combo_dmg:5, combo_cooldown:10, right_click_cooldown:30, combo_range:3.0, combo_reach:1.5, reach_mod:-1.3, max_damage:59}
execute if entity @s[tag=vexp.stone] run data modify storage vexp:dungeons.weapon params merge value {item_id:"stone_axe", name:"Hacha de Piedra", model:"vexp:none", quality:"normal", dmg:9.0, spd:-2.4, combo_dmg:8, combo_cooldown:16, right_click_cooldown:30, combo_range:3.0, combo_reach:1.5, reach_mod:-1.3, max_damage:131}
execute if entity @s[tag=vexp.bone] run data modify storage vexp:dungeons.weapon params merge value {item_id:"stone_axe", name:"Hacha de Hueso", model:"vexp:none", quality:"normal", dmg:9.0, spd:-3.0, combo_dmg:9, combo_cooldown:20, right_click_cooldown:30, combo_range:3.0, combo_reach:1.5, reach_mod:-1.3, max_damage:96}
execute if entity @s[tag=vexp.copper] run data modify storage vexp:dungeons.weapon params merge value {item_id:"iron_axe", name:"Hacha de Cobre", model:"vexp:none", quality:"normal", dmg:9.0, spd:-3.2, combo_dmg:9, combo_cooldown:24, right_click_cooldown:30, combo_range:3.0, combo_reach:1.5, reach_mod:-1.3, max_damage:250}
execute if entity @s[tag=vexp.iron] run data modify storage vexp:dungeons.weapon params merge value {item_id:"iron_axe", name:"Hacha de Hierro", model:"vexp:none", quality:"normal", dmg:10.0, spd:-3.4, combo_dmg:10, combo_cooldown:28, right_click_cooldown:30, combo_range:3.0, combo_reach:1.5, reach_mod:-1.3, max_damage:250}
execute if entity @s[tag=vexp.gold] run data modify storage vexp:dungeons.weapon params merge value {item_id:"golden_axe", name:"Hacha de Oro", model:"vexp:none", quality:"gold", dmg:7.0, spd:-2.8, combo_dmg:7, combo_cooldown:10, right_click_cooldown:30, combo_range:3.0, combo_reach:1.5, reach_mod:-1.3, max_damage:32}
