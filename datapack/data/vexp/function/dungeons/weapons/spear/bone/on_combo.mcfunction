...
execute as @p[tag=vexp.attacker,limit=1] at @s positioned ~ ~1.5 ~ positioned ^ ^ ^7 run function vexp:dungeons/fx/aeo_waves/common
execute as @p[tag=vexp.attacker,limit=1] at @s positioned ~ ~1.5 ~ positioned ^ ^ ^8 run function vexp:dungeons/fx/aeo_waves/common

# Feedback
execute positioned ~ ~1 ~ run function vexp:dungeons/fx/hits/bone_hit
