...
execute if entity @s[tag=vexp.stone] run data modify storage vexp:dungeons.weapon params merge value {item_id:"bow", name:"Arco de Piedra", model:"vexp:stone_bow", quality:"normal", combo_type:"short_combo", dmg:3.0, spd:-2.0, combo_dmg:5, combo_cooldown:10, right_click_cooldown:20, combo_range:4.5, combo_reach:3.7, reach_mod:0.0, max_damage:512}
execute if entity @s[tag=vexp.bone] run data modify storage vexp:dungeons.weapon params merge value {item_id:"bow", name:"Arco de Hueso", model:"vexp:none", quality:"normal", combo_type:"short_combo", dmg:3.0, spd:-2.3, combo_dmg:6, combo_cooldown:12, right_click_cooldown:20, combo_range:4.7, combo_reach:3.9, reach_mod:0.0, max_damage:448}
execute if entity @s[tag=vexp.copper] run data modify storage vexp:dungeons.weapon params merge value {item_id:"bow", name:"Arco de Cobre", model:"vexp:copper_bow", quality:"normal", combo_type:"short_combo", dmg:3.0, spd:-2.6, combo_dmg:6, combo_cooldown:14, right_click_cooldown:20, combo_range:4.8, combo_reach:4.0, reach_mod:0.0, max_damage:650}
execute if entity @s[tag=vexp.iron] run data modify storage vexp:dungeons.weapon params merge value {item_id:"bow", name:"Arco de Hierro", model:"vexp:iron_bow", quality:"normal", combo_type:"short_combo", dmg:4.0, spd:-2.9, combo_dmg:7, combo_cooldown:18, right_click_cooldown:20, combo_range:5.0, combo_reach:4.0, reach_mod:0.0, max_damage:768}
execute if entity @s[tag=vexp.gold] run data modify storage vexp:dungeons.weapon params merge value {item_id:"bow", name:"Arco de Oro", model:"vexp:golden_bow", quality:"gold", combo_type:"short_combo", dmg:2.0, spd:-2.7, combo_dmg:5, combo_cooldown:15, right_click_cooldown:20, combo_range:4.5, combo_reach:3.5, reach_mod:0.0, max_damage:256}
