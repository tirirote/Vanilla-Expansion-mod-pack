...
execute as @a[scores={vexp.bow_shot_delta=1..}] if items entity @s weapon.mainhand *[custom_data~{vexp:{item:"bow"}}] at @s run function vexp:dungeons/weapons/bow/arrows/mark_new_arrow
