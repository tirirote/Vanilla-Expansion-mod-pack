...
execute as @e[type=minecraft:arrow,tag=!vexp.bow_arrow,distance=..6,sort=nearest,limit=1,nbt={inGround:0b}] at @s run function vexp:dungeons/weapons/bow/arrows/replace_with_custom
...
execute as @e[type=minecraft:arrow,tag=vexp.bow_arrow,tag=!vexp.arrow.damage_applied,distance=..6,sort=nearest,limit=1] run function vexp:dungeons/weapons/bow/arrows/apply_tier_damage
