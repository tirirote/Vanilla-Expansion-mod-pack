...
execute if score @s vexp.bow_draw_ticks matches 3.. if items entity @s weapon.mainhand *[custom_data~{vexp:{combo:{quality:"netherite"}}}] run function vexp:dungeons/weapons/bow/netherite/on_right_click
execute if score @s vexp.bow_draw_ticks matches 3.. if items entity @s weapon.mainhand *[custom_data~{vexp:{combo:{quality:"echo"}}}] run function vexp:dungeons/weapons/bow/echo/on_right_click
