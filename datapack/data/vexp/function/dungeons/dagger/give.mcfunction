...
execute if entity @s[tag=vexp.wood] run data modify storage vexp:dungeons.weapon params merge value {item_id:"wooden_sword", name:"Daga de Madera", model:"vexp:wooden_dagger", material:"wood", quality:"normal", dmg:2.0, spd:2.6, combo_dmg:2, combo_cooldown:3, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:59}
