...
execute if entity @s[tag=vexp.wood] run data modify storage vexp:dungeons.weapon params merge value {item_id:"wooden_sword", name:"Daga de Madera", model:"vexp:wooden_dagger", material:"wood", quality:"normal", dmg:2.0, spd:2.6, combo_dmg:2, combo_cooldown:2, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:59}
execute if entity @s[tag=vexp.stone] run data modify storage vexp:dungeons.weapon params merge value {item_id:"stone_sword", name:"Daga de Piedra", model:"vexp:stone_dagger", material:"stone", quality:"normal", dmg:2.0, spd:2.4, combo_dmg:2, combo_cooldown:3, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:131}
execute if entity @s[tag=vexp.bone] run data modify storage vexp:dungeons.weapon params merge value {item_id:"iron_sword", name:"Daga de Hueso", model:"vexp:bone_dagger", material:"bone", quality:"normal", dmg:3.0, spd:2.2, combo_dmg:3, combo_cooldown:4, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:96}
execute if entity @s[tag=vexp.copper] run data modify storage vexp:dungeons.weapon params merge value {item_id:"copper_sword", name:"Daga de Cobre", model:"vexp:copper_dagger", material:"copper", quality:"normal", dmg:3.0, spd:2.2, combo_dmg:3, combo_cooldown:5, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:250}
execute if entity @s[tag=vexp.iron] run data modify storage vexp:dungeons.weapon params merge value {item_id:"iron_sword", name:"Daga de Hierro", model:"vexp:iron_dagger", material:"iron", quality:"normal", dmg:4.0, spd:2.0, combo_dmg:4, combo_cooldown:6, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:250}
execute if entity @s[tag=vexp.gold] run data modify storage vexp:dungeons.weapon params merge value {item_id:"golden_sword", name:"Daga de Oro", model:"vexp:golden_dagger", material:"gold", quality:"normal", dmg:3.0, spd:1.8, combo_dmg:3, combo_cooldown:2, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-1.0, max_damage:32}
execute if entity @s[tag=vexp.diamond] run data modify storage vexp:dungeons.weapon params merge value {item_id:"diamond_sword", name:"Daga de Diamante", model:"vexp:diamond_dagger", material:"diamond", quality:"normal", dmg:5.0, spd:1.6, combo_dmg:5, combo_cooldown:7, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-0.5, max_damage:1561}
execute if entity @s[tag=vexp.netherite] run data modify storage vexp:dungeons.weapon params merge value {item_id:"netherite_sword", name:"Daga de Netherite", model:"vexp:netherite_dagger", material:"netherite", quality:"netherite", dmg:6.0, spd:1.4, combo_dmg:6, combo_cooldown:10, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-0.5, max_damage:2031}
execute if entity @s[tag=vexp.echo] run data modify storage vexp:dungeons.weapon params merge value {item_id:"netherite_sword", name:"Daga Resonante", model:"vexp:resonance_dagger", material:"echo", quality:"echo", dmg:6.0, spd:1.4, combo_dmg:6, combo_cooldown:7, right_click_cooldown:12, combo_range:1.5, combo_reach:1.5, reach_mod:-0.5, max_damage:1891}
execute if entity @s[tag=vexp.amethyst] run data modify storage vexp:dungeons.weapon params merge value {item_id:"netherite_sword", name:"Daga de Amatista", model:"vexp:amethyst_dagger", material:"amethyst", quality:"amethyst", dmg:6.0, spd:1.4, combo_dmg:6, combo_cooldown:8, right_click_cooldown:12, combo_range:1.0, combo_reach:2.5, reach_mod:-0.5, max_damage:1351}
