...
execute if entity @s[tag=vexp.netherite] run function vexp:dungeons/dagger/projectile/netherite/on_spawn
execute if entity @s[tag=vexp.echo] run function vexp:dungeons/dagger/projectile/echo/on_spawn
execute if entity @s[tag=vexp.amethyst] run function vexp:dungeons/dagger/projectile/amethyst/on_spawn
