...
execute if entity @s[tag=vexp.wood] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:wooden_sword",components:{"minecraft:custom_model_data":{strings:["vexp:wooden_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.25f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}
execute if entity @s[tag=vexp.stone] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:stone_sword",components:{"minecraft:custom_model_data":{strings:["vexp:stone_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.25f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}
execute if entity @s[tag=vexp.iron] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:iron_sword",components:{"minecraft:custom_model_data":{strings:["vexp:iron_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.25f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}
execute if entity @s[tag=vexp.gold] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:golden_sword",components:{"minecraft:custom_model_data":{strings:["vexp:golden_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.25f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}

execute if entity @s[tag=vexp.diamond] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:diamond_sword",components:{"minecraft:custom_model_data":{strings:["vexp:diamond_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.5f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}

execute if entity @s[tag=vexp.copper] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:copper_sword",components:{"minecraft:custom_model_data":{strings:["vexp:copper_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.25f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}
execute if entity @s[tag=vexp.netherite] run summon item_display ~ ~ ~ {Tags:["vexp.dagger_stuck_visual"],item:{id:"minecraft:netherite_sword",components:{"minecraft:custom_model_data":{strings:["vexp:netherite_dagger"]}}},transformation:{translation:[0f,0f,0f],scale:[0.8f,0.8f,0.8f],left_rotation:[-.25f,.5f,.5f,0f],right_rotation:[0f,0f,0f,1f]},interpolation_duration:1,teleport_duration:1}

execute run summon interaction ~ ~ ~ {Tags:["vexp.dagger_stuck_interact"],width:0.8f,height:1.5f}
