...
execute as @e[type=minecraft:armor_stand,tag=vexp.temp_projectile,tag=vexp.handgun_bullet,distance=..3] at @s rotated as @p[tag=vexp.projectile_owner,limit=1] run function vexp:projectile/spawn
