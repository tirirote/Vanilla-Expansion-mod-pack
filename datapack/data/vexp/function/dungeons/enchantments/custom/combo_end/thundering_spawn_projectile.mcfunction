...
execute as @e[type=minecraft:armor_stand,tag=enchantment_thunder,tag=vexp.temp_projectile,sort=nearest,limit=1,distance=..2] at @s run function vexp:projectile/spawn
