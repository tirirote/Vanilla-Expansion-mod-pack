...
execute if score #ench_healing vexp.math matches 1 run effect give @s minecraft:instant_health 1 0 true
execute if score #ench_healing vexp.math matches 1 run effect give @s minecraft:absorption 3 0 true

execute if score #ench_healing vexp.math matches 2.. run effect give @s minecraft:instant_health 1 1 true
...
#Healing FX
function vexp:utils/fx/healing
