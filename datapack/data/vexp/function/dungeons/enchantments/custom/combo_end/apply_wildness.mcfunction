...
execute if score @s vexp.enchant.wildness matches 1 run effect give @s minecraft:speed 3 1 true
execute if score @s vexp.enchant.wildness matches 2.. run effect give @s minecraft:speed 3 2 true

execute if score @s vexp.enchant.wildness matches 1 run effect give @s minecraft:strength 3 0 true
execute if score @s vexp.enchant.wildness matches 2.. run effect give @s minecraft:strength 3 1 true

execute if score @s vexp.enchant.wildness matches 1 run scoreboard players remove @s vexp.combo_cooldown 2
execute if score @s vexp.enchant.wildness matches 2.. run scoreboard players remove @s vexp.combo_cooldown 4
