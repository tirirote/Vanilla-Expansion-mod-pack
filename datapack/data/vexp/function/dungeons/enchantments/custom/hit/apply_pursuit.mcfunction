...
execute if score #ench_pursuit vexp.math matches 2.. run scoreboard players set #pursuit_base_pct vexp.math 20
...
# bonus = eff_damage * base_pct * missing_hp / max_hp * 100
...
scoreboard players operation #pursuit_max_hp vexp.math *= #const_100 vexp.math
