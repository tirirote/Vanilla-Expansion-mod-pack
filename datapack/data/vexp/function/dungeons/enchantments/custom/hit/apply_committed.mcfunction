...
execute as @e[tag=vexp.hitted,tag=vexp.committed_mark,distance=..16] at @s run function vexp:dungeons/enchantments/custom/hit/committed_deal_bonus with storage vexp:temp
