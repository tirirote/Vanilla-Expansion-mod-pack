...
scoreboard players set #ench_sweep vexp.math 0
...
execute if data entity @s SelectedItem.components."minecraft:enchantments"."minecraft:sweeping_edge" store result score #ench_sweep vexp.math run data get entity @s SelectedItem.components."minecraft:enchantments"."minecraft:sweeping_edge" 1

execute if score #ench_sharp vexp.math matches 1.. run function vexp:dungeons/enchantments/vanilla/hit/apply_sharpness
execute if score #ench_smite vexp.math matches 1.. run function vexp:dungeons/enchantments/vanilla/hit/apply_smite
execute if score #ench_bane vexp.math matches 1.. run function vexp:dungeons/enchantments/vanilla/hit/apply_bane_of_arthropods
execute if score #ench_fire vexp.math matches 1.. run function vexp:dungeons/enchantments/vanilla/hit/apply_fire_aspect
execute if score #ench_kb vexp.math matches 1.. run function vexp:dungeons/enchantments/vanilla/hit/apply_knockback
execute if score #ench_sweep vexp.math matches 1.. run function vexp:dungeons/enchantments/vanilla/hit/apply_sweeping_edge
