...
execute as @e[type=marker,tag=vexp.temp_projectile,tag=vexp.nether_projectile,distance=..3] at @s rotated as @p[tag=vexp.projectile_owner,limit=1] run function vexp:projectile/spawn
