...
execute if items entity @s weapon.mainhand *[custom_data~{vexp:{combo:{quality:"resonance"}}}] as @e[type=minecraft:arrow,tag=vexp.bow_arrow,tag=!vexp.arrow.type_assigned,distance=..6,sort=nearest,limit=1] run tag @s add vexp.resonance_arrow
...
execute if items entity @s weapon.mainhand *[custom_data~{vexp:{combo:{quality:"resonance"}}}] if score @s vexp.bow_draw_ticks matches 10.. as @e[type=minecraft:arrow,tag=vexp.bow_arrow,tag=vexp.resonance_arrow,tag=!vexp.arrow.type_assigned,distance=..6,sort=nearest,limit=1] run tag @s add vexp.combo_arrow_charged
