...
data modify storage vexp:arrow_config set set value {common: {normal: 6, charged: 8}, netherite: {normal: 8, charged: 10}, resonance: {normal: 9, charged: 11}, gold: {normal: 7, charged: 9}, diamond: {normal: 9, charged: 11}, glowing: {normal: 7, charged: 9}}
