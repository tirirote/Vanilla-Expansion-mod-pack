...
# Charging
$execute if score @s $(score) matches ..$(start) positioned ~ ~1.6 ~ run particle entity_effect{color:1543477023} ^ ^ ^2 0 0 0 1 0
$execute if score @s $(score) matches $(start)..$(end) positioned ~ ~1.6 ~ run particle entity_effect{color:-1996506368} ^ ^ ^2 0 0 0 1 0
$execute if score @s $(score) matches $(end).. positioned ~ ~1.6 ~ run particle entity_effect{color:16763967} ^ ^ ^2 0 0 0 1 0
