...
function vexp:utils/feedback/swoosh/spawn_swoosh {model:"vexp:fire",position:"~ ~1 ~",face_player:1,scale:1.7,random_pos:0,lifetime:7,spawn_on_player:0,follow_owner:0,follow_offset_x:0,follow_offset_y:1,follow_offset_z:0}
