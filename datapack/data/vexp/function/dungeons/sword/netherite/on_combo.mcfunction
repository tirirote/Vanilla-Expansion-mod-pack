...
execute as @p[tag=vexp.attacker,limit=1] at @s run summon marker ~ ~1 ~ {Tags:["vexp.projectile","vexp.temp_projectile","vexp.sword_nether_projectile"],data:{proj_type:"nether_sword"}}
