...
summon item_display ~ ~0.65 ~ {Tags:["vexp.combo_hitbox_indicator", "vexp.hitbox_indicator.new"],item:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:custom_model_data":{strings:["vexp:hit_indicator_candidate"]}}},transformation:{left_rotation:[0.707f,0f,0f,0.707f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,1f],scale:[2.7f,2.7f,2.7f]},brightness:{block:15,sky:15},teleport_duration:2,interpolation_duration:1,view_range:1.0f}
