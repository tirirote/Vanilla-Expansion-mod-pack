...
execute if score #random_swoosh vexp.math matches 0 run function vexp:dungeons/fx/swooshes/combo_swoosh_0
execute if score #random_swoosh vexp.math matches 1 run function vexp:dungeons/fx/swooshes/combo_swoosh_1
execute if score #random_swoosh vexp.math matches 2 run function vexp:dungeons/fx/swooshes/combo_swoosh_2
