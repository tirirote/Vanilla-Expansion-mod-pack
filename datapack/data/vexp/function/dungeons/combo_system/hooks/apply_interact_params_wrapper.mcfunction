...
execute if score @s vexp.combo_cooldown matches 0 run function vexp:dungeons/combo_system/hooks/apply_interact_params with storage vexp:dungeons.weapon combo_params
