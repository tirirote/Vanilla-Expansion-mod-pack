...
$execute if data storage vexp:dungeons.weapon combo_params{quality:"glowing"} as @e[tag=vexp.hitted,distance=..8] at @s run function vexp:dungeons/$(item)/glowing/on_combo
