...
scoreboard players operation @s vexp.cooldown_tenths = @s vexp.combo_cooldown
...
# Cooldown Display
execute if score @s vexp.combo_cooldown matches 1.. run function vexp:dungeons/combo_system/cooldown_display_bar
