...
execute store result score #cooldown_ticks vexp.math run scoreboard players get @s vexp.combo_cooldown
...
# Cooldown Display
execute if score @s vexp.combo_cooldown matches 1.. run function vexp:dungeons/combo_system/cooldown_display_bar with storage vexp:temp cooldown_display
execute if score @s vexp.combo_cooldown matches ..1 run title @s actionbar [{"text":""}]
