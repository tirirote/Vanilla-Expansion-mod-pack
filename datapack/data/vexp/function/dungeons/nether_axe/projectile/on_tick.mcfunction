...
function vexp:utils/feedback/dust_particle {initialColor: [0.2, 0.2, 0.2], finalColor: [0.4, 0.35, 0.3], scale: 0.8, dX: 0, dY: 0, dZ: 0, speed: 1, count: 1}
...
execute as @e[tag=vexp.axe_display,limit=1,distance=..2,sort=nearest] at @s run tp @s ~ ~ ~ ~20 ~
