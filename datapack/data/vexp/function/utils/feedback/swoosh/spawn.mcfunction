...
execute if score #swoosh_scale_rand vexp.math matches 1 run data merge entity @e[type=item_display,tag=vexp.swoosh.new,limit=1,sort=nearest,distance=..3] {transformation:{scale:[2f,1f,0.25f]}}
execute if score #swoosh_scale_rand vexp.math matches 2 run data merge entity @e[type=item_display,tag=vexp.swoosh.new,limit=1,sort=nearest,distance=..3] {transformation:{scale:[0.25f,1f,2f]}}
execute if score #swoosh_scale_rand vexp.math matches 3 run data merge entity @e[type=item_display,tag=vexp.swoosh.new,limit=1,sort=nearest,distance=..3] {transformation:{scale:[1.5f,1f,0.125f]}}
execute if score #swoosh_scale_rand vexp.math matches 4 run data merge entity @e[type=item_display,tag=vexp.swoosh.new,limit=1,sort=nearest,distance=..3] {transformation:{scale:[0.125f,1f,1.5f]}}
