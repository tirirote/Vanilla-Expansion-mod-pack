...
# Modelo en item_display
execute if data entity @s data.proj.model run data modify entity @s item set value {id:"firework_rocket",count:1}
execute if data entity @s data.proj.model run data modify entity @s item.components."minecraft:custom_model_data" set from entity @s data.proj.model
...
execute unless data entity @s data.proj.model run data modify entity @s data.proj.model set value ""
