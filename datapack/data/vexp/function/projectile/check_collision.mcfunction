...
execute if entity @s[tag=vexp.dagger_projectile] positioned ~ ~-1 ~ if entity @e[predicate=vexp:is_target,distance=..1.5,sort=nearest] run function vexp:projectile/on_hit_mob

# Otros proyectiles usan detección estándar
execute if entity @s[tag=!vexp.dagger_projectile] if entity @e[predicate=vexp:is_target,distance=..1.5,sort=nearest] run function vexp:projectile/on_hit_mob
