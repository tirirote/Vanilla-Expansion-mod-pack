...
execute as @a[tag=vexp.face_owner_temp,limit=1] at @s positioned ~ ~1.5 ~ at @e[tag=vexp.face_projectile_temp,limit=1] rotated as @s run tp @e[tag=vexp.face_projectile_temp,limit=1] ~ ~ ~ ~ ~
