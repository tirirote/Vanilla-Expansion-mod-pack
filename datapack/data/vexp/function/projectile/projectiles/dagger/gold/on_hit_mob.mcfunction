...
execute as @p[tag=vexp.projectile_owner,limit=1] at @s if entity @e[predicate=vexp:is_target,tag=vexp.glow_marked,distance=..16,sort=nearest,limit=1] run function vexp:dungeons/states/gold_buffed
...
function vexp:utils/hits/gold_hit
