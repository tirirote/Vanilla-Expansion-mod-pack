...
execute at @s as @e[tag=vexp.dagger_stuck_interact,distance=..1.5] if score @s vexp.id = #temp vexp.id run function vexp:projectile/projectiles/dagger/stuck/check_pickup
