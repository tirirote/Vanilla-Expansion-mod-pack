...
data modify entity @s data.proj set value {speed:0.6, lifetime:90, damage:1, gravity:4.0, spin:6.0, homing_distance:6.0, randomness:0.1, model:{strings:["vexp:common_spell"]}}
data modify entity @s Glowing set value true
data modify entity @s glow_color_override set value 13561855
