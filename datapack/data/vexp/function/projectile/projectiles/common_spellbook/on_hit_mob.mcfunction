...
function vexp:utils/feedback/trail_particle {col:-2228225, duration:15, dX:1, dY:1, dZ:1, count:5, speed:1}
particle end_rod ~ ~ ~ 0.1 0.1 0.1 0.1 3
function vexp:dungeons/fx/hits/strong_punch_hit
