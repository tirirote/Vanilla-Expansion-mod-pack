...
execute as @e[predicate=vexp:is_target,distance=..2,sort=nearest,limit=1] at @s facing entity @p[tag=vexp.projectile_owner] eyes run function vexp:utils/motion/apply_knockback {strength:2.5, y:0.1}


particle sculk_charge_pop ~ ~ ~ .2 .2 .2 0.25 3
