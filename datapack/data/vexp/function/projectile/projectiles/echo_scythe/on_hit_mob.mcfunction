...
execute as @e[tag=vexp.proj_target] at @s run function vexp:dungeons/states/echo_stunned
execute as @e[tag=vexp.proj_target] at @s facing entity @p[tag=vexp.projectile_owner] eyes run function vexp:utils/motion/apply_knockback {strength:0.1, y:0.01}
